...
type AboutUsSectionProps = React.ComponentProps<"section">
...
const stats: Stat[] = [
  { icon: <Award className="h-6 w-6" />, value: 150, label: "Projects Completed", suffix: "+" },
  { icon: <Users className="h-6 w-6" />, value: 1200, label: "Happy Clients", suffix: "+" },
  { icon: <Calendar className="h-6 w-6" />, value: 12, label: "Years Experience", suffix: "" },
  { icon: <TrendingUp className="h-6 w-6" />, value: 98, label: "Satisfaction Rate", suffix: "%" },
]
...
function ServiceItem({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="mt-3 flex items-center gap-1 pl-12 text-xs font-medium text-[#88734C] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
        initial={{ opacity: 0 }}
        animate={{ opacity: 0 }}
      >
...
function StatCounter({ icon, value, label, suffix, delay }: StatCounterProps) {
  ...
  return (
    <motion.div
      className="group flex flex-col items-center rounded-xl bg-white/50 p-6 text-center shadow-sm backdrop-blur-sm transition-colors duration-300 hover:bg-white"
      variants={{
...
export function AboutUsSection({ className, ...props }: AboutUsSectionProps) {
  ...
  return (
    <section
      ref={sectionRef}
      className={cn(
        "relative w-full overflow-hidden bg-gradient-to-b from-[#F2F2EB] to-[#F8F8F2] px-4 py-24 text-[#202e44]",
        className,
      )}
      {...props}
    >
      <motion.div
        className="absolute left-10 top-20 h-64 w-64 rounded-full bg-[#88734C]/5 blur-3xl"
        style={{ y: y1, rotate: rotate1 }}
      />
      <motion.div
        className="absolute bottom-20 right-10 h-80 w-80 rounded-full bg-[#A9BBC8]/5 blur-3xl"
        style={{ y: y2, rotate: rotate2 }}
      />
      <motion.div
        className="absolute left-1/4 top-1/2 h-4 w-4 rounded-full bg-[#88734C]/30"
        animate={{
          y: [0, -15, 0],
          opacity: [0.5, 1, 0.5],
        }}
      ...
      >
        ...
        <motion.p className="mx-auto mb-16 max-w-2xl text-center text-[#202e44]/80" variants={itemVariants}>
        ...
        <div className="relative grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="order-first mb-8 flex items-center justify-center md:order-none md:mb-0">
            <motion.div className="relative w-full max-w-xs" variants={itemVariants}>
              ...
              <motion.div
                className="absolute -right-8 -top-4 h-16 w-16 rounded-full bg-[#88734C]/10"
